/* eslint-disable */
// Generated by Wrangler by running `wrangler types ./src/server/worker-configuration.d.ts` (hash: 51e59172236863c7941d06a8075b161c)
// Runtime types generated with workerd@1.20260603.1 2025-04-01 
interface __BaseEnv_Env {
	ASSETS: Fetcher;
	Chat: DurableObjectNamespace<import("./index").Chat>;
	Registry: DurableObjectNamespace<import("./index").Registry>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./index");
		durableNamespaces: "Chat" | "Registry";
	}
